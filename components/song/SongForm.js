...
import {createSong, getAllSongs, updateSong, uploadImage} from "@lib/api";
...
export default function SongForm({session, songToEdit}) {
    ...
    const handleSubmit = async (e) => {
        ...
        // upload image
        if (base64Image) {
            song.filePath = await uploadImage(base64Image, "artistimages")
        }
    ...
    return (<form onSubmit={handleSubmit} className={styles.songForm}>
        <fieldset>
            <label>Name</label>
